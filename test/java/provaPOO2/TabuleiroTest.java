...
public class TabuleiroTest {
	...
	/**
	 * Testar se está retornando as duas cartas
	 */
	@Test
	public void retornarCartasViradasTest() {
		Tabuleiro tabuleiro = new Tabuleiro();
		tabuleiro.criarCartas();
		...
		CartaLogica[] cartasViradas = new CartaLogica[2];
		cartasViradas = tabuleiro.retornarCartasViradas();
		
		Assertions.assertEquals('B', cartasViradas[0].getValor());
		Assertions.assertEquals('D', cartasViradas[1].getValor());
	}
}
